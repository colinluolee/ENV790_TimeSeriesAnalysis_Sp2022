...
acf(mydata[,1],lag.max=40,main=paste("Total Biomass Energy Production"))
acf(mydata[,2],lag.max=40,main=paste("Total Renewable Energy Production"))
acf(mydata[,3],lag.max=40,main=paste("Hydroelectric Power Consumption"))

par(mfrow=c(1,3))  #place plot side by side
pacf(mydata[,1],lag.max=40,main=paste("Total Biomass Energy Production"))
pacf(mydata[,2],lag.max=40,main=paste("Total Renewable Energy Production"))
pacf(mydata[,3],lag.max=40,main=paste("Hydroelectric Power Consumption"))
...
```{r Q5}
par(mfrow=c(1,3))  #place plot side by side
acf(detrend_mydata_biomass,lag.max=40,main=paste("Total Biomass Energy Production"))
acf(detrend_mydata_renewable,lag.max=40,main=paste("Total Renewable Energy Production"))
acf(detrend_mydata_hydro,lag.max=40,main=paste("Hydroelectric Power Consumption"))

par(mfrow=c(1,3))  #place plot side by side
pacf(detrend_mydata_biomass,lag.max=40,main=paste("Total Biomass Energy Production"))
pacf(detrend_mydata_renewable,lag.max=40,main=paste("Total Renewable Energy Production"))
pacf(detrend_mydata_hydro,lag.max=40,main=paste("Hydroelectric Power Consumption"))
```
