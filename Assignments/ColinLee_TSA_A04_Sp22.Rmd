...
For some reason I could not get the legend to appear after 2 hours of debugging.

```{r Q4}
ggplot(totaldata) +
            geom_line(aes(x=totaldata[,4],y=totaldata[,1]), color= "red") +
            geom_line(aes(x=totaldata[,4],y=totaldata[,2]), color = "blue") +
            geom_line(aes(x=totaldata[,4],y=totaldata[,3]), color = "black") +
            labs(y = "Trillion Btu",
            x = "Month",
            title = "Normal, Detrended, and Differenced Total Renewable Energy Production",
            color = "") +
            scale_color_manual(values = c("red", "black", "blue"),
                                labels = c("Total Renewable Energy Production", "Differenced Total Renewable Energy Production","Detrended Total Renewable Energy Production")) +
