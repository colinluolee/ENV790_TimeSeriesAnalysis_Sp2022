...
#df_decompose_wind <- cbind(full_wind_data$Date,wind_random,wind_seasonal,wind_trend)#similarly rows could be added using rbind()

df_decompose_wind <- data.frame("Date"=full_wind_data$Date,wind_random,wind_seasonal,wind_trend)


#Ex4: Inspect the data frame using head() and tail()
head(df_decompose_wind)
tail(df_decompose_wind)
